 ...
 * ```
 * 
 * Once these are included, you can run 'loadks().then(function(ks) { // use 'ks' here })
 * 
 *
...
function loadks() {
    return libks().then(function (ks) {
        ...
        // Get version string
        ks.verstr = ks.UTF8ToString(ks.cwrap('ks_get_verstr', ptr_t, [])())
