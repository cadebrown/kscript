...
static int kern(int N, nxar_t* inp, int len, void* _data) {
    ...
    if (dtype == nxd_float) {
        ...
        for (i = 0; i < len; i++, pR += sR, pX += sX) {
            TYPE vX = *(TYPE*)pX;
        #ifdef KS_HAVE_atanhf
            *(TYPE*)pR = atanhf(vX);
        #else
            KS_THROW(kst_Error, "Kernel '%s' is not supported for dtype %R, function(s) not found: atanhf", K_NAME, dtype);
            return 1;
        #endif
        }
        ...
        #ifdef KS_HAVE_atanh
            *(TYPE*)pR = atanh(vX);
        #elif defined(KS_HAVE_atanhf)
            *(TYPE*)pR = atanhf(vX);
        #else
            KS_THROW(kst_Error, "Kernel '%s' is not supported for dtype %R, function(s) not found: atanh, atanhf", K_NAME, dtype);
            return 1;
        #endif
        }
        ...
        for (i = 0; i < len; i++, pR += sR, pX += sX) {
            TYPE vX = *(TYPE*)pX;
        #ifdef KS_HAVE_atanhl
            *(TYPE*)pR = atanhl(vX);
        #elif defined(KS_HAVE_atanh)
            *(TYPE*)pR = atanh(vX);
        #elif defined(KS_HAVE_atanhf)
            *(TYPE*)pR = atanhf(vX);
        #else
            KS_THROW(kst_Error, "Kernel '%s' is not supported for dtype %R, function(s) not found: atanhl, atanh, atanhf", K_NAME, dtype);
            return 1;
        #endif
        }
        ...
        for (i = 0; i < len; i++, pR += sR, pX += sX) {
            TYPE vX = *(TYPE*)pX;
        #ifdef KS_HAVE_atanhf128
            *(TYPE*)pR = atanhf128(vX);
            ...
            *(TYPE*)pR = atanhf(vX);
        #else
            KS_THROW(kst_Error, "Kernel '%s' is not supported for dtype %R, function(s) not found: atanhf128, atanhl, atanh, atanhf", K_NAME, dtype);
            return 1;
        #endif
        }
...
bool nx_atanh(nxar_t r, nxar_t x) {
